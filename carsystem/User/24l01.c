...
const u8 TX_ADDRESS[TX_ADR_WIDTH]={0x03,0xFF,0xFF,0xFF,0xFF}; //发送地址
const u8 RX_ADDRESS[RX_ADR_WIDTH]={0x03,0xFF,0xFF,0xFF,0xFF}; //发送地址 小车地址
const u8 RX_ADDRESS1[RX_ADR_WIDTH]={0x01,0xFF,0xFF,0xFF,0xFF}; //发送地址

//初始化24L01的IO口
void NRF24L01_spi1(void)
{
