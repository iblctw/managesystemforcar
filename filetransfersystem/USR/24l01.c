...
const u8 RX_ADDRESS[RX_ADR_WIDTH]={0x01,0xFF,0xFF,0xFF,0xFF}; //发送地址 上位机地址
const u8 RX_ADDRESS1[RX_ADR_WIDTH]={0x02,0xFF,0xFF,0xFF,0xFF}; //接收地址
...
void USART_receive(u8 *ptr)
{
	...
	for(i=0;i<6;i++)
   {	  
		*(ptr+i)=USART_ReceiveData(USART1); // 发送数据
